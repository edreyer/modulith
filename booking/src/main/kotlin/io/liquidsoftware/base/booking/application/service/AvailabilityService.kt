...
internal class AvailabilityService {
  ...
  suspend fun getAvailability(appts: List<io.liquidsoftware.base.booking.domain.Appointment>): List<LocalTime> {
  ...
  suspend fun isTimeAvailable(appts: List<io.liquidsoftware.base.booking.domain.Appointment>, time: LocalTime): Boolean =
