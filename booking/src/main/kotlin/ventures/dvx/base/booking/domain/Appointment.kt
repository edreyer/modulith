package ventures.dvx.base.booking.domain
...
import ventures.dvx.base.booking.AppointmentId
  ...
  companion object {
    fun of(userId: String, startTime: LocalDateTime, duration: Long):
      ...
      return AppointmentId.create().validNel().zip (
        ...
        DraftAppointment(AppointmentData(aId, uId, st.value, Duration.ofMinutes(d.value)))
      }
    }
  }
}
  ...
  companion object {
    fun of(apptId: String, userId: String, startTime: LocalDateTime, duration: Long):
      ...
      return AppointmentId.of(apptId).zip(
        ...
        ScheduledAppointment(AppointmentData(aId, uId, st, Duration.ofMinutes(d.value)))
      }
    }
    fun of(draft: DraftAppointment): ScheduledAppointment = ScheduledAppointment(
  ...
  companion object {
    fun of(apptId: String, userId: String, startTime: LocalDateTime, duration: Long):
      ...
      return AppointmentId.of(apptId).zip(
        ...
        InProgressAppointment(AppointmentData(aId, uId, st.value, Duration.ofMinutes(d.value)))
      }
    }
  }
}
  ...
  companion object {
    fun of(apptId: String, userId: String, startTime: LocalDateTime, duration: Long, completeDate: LocalDateTime):
      ...
      return AppointmentId.of(apptId).zip(
        ...
        CompleteAppointment(cd.value, AppointmentData(aId, uId, st.value, Duration.ofMinutes(d.value)))
      }
    }
  }
}
  ...
  companion object {
    fun of(apptId: String, userId: String, startTime: LocalDateTime, duration: Long, cancelDate: LocalDateTime):
      ...
      return AppointmentId.of(apptId).zip(
        ...
        CancelledAppointment(cd, AppointmentData(aId, uId, st, d))
      }
    }
    fun of(appt: DraftAppointment): CancelledAppointment = CancelledAppointment(
      LocalDateTime.now(), AppointmentData(appt.id, appt.userId, appt.startTime, appt.duration)
    )
    fun of(appt: ScheduledAppointment): CancelledAppointment = CancelledAppointment(
      LocalDateTime.now(), AppointmentData(appt.id, appt.userId, appt.startTime, appt.duration)
    )
  }
}
