...
interface UserAdminApi {
  suspend fun enableUser(command: EnableUserCommand): Either<ApplicationError, UserEnabledEvent>
  suspend fun disableUser(command: DisableUserCommand): Either<ApplicationError, UserDisabledEvent>
}
